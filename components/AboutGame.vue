...
export default {
    ...
    data() {
        ...
        const heroesMessages = [
            'Heroes are inspiring people who have faced their own dragons and achieved something epic. They are here to inspire you and give unique quests based on the challenges that they faced on their rise to greatness. Visit the Hall of Heroes where their origin stories are revealed. Each month after launch we will reveal a new Hero that will be featured in the game. They range from celebrities to everyday people from all walks of life, who have teamed up with Facing Dragons to support the mission and make a difference. <br><br> You could even become the next Hero! Become a Hero alongside <strong> Tory Lanez, Bibiano Fernandes </strong> and <strong> Steph Jeavons!</strong> ',
            ...
            His journey to the top is one of courage and a never-quit attitude. Tory and his dad, Sonstar, are launching their book 360 Phenomenon later this year. Their mission aligns perfectly with ours and we are excited to team up with them. <br><br>
            "Seeing how people get when people come to you and tell you, 'Yo, that just gave me chills' or, 'That inspired me to do something,' it’s like  'Wow, my purpose has been given to somebody who probably didn’t even expect to see me tonight.' It’s the best feeling that I could ask for, and not just because someone is saying, 'Yo, you’re the man,' but because it’s like [they’re saying] 'Yo, you helped my life in some sort of way.'” - <strong>Tory Lanez</strong>`
        ]
        return {
            gameFeatures,
            heroesMessages,
